package fpoly.acount.lab_3.adapter;
...
import fpoly.acount.lab_3.MainActivity;
import fpoly.acount.lab_3.R;
import fpoly.acount.lab_3.dao.TaskInfoDAO;
import fpoly.acount.lab_3.model.TaskInFo;
...
public class TaskInfoAdapter extends RecyclerView.Adapter<TaskInfoAdapter.ViewHolderInfo>{
    ...
    public ViewHolderInfo onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_tskinf,parent, false);
